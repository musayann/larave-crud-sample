                ...
                <form class="w-full p-6" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="first_name" type="text"
                            class="form-input w-full @error('first_name')  border-red-500 @enderror" name="first_name"
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="last_name" type="text"
                            class="form-input w-full @error('last_name')  border-red-500 @enderror" name="last_name"
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <select id="type" name="type"  class="form-input w-full @error('type')  border-red-500 @enderror" name="type" required="">

                            <option value="sos" selected="selected">SOS</option>
